...
public class TypeTemplateController {
	...
	public Result Names(@RequestBody TbTypeTemplate typeTemplate)
	{
		try {
			typeTemplateService.Names(typeTemplate);
	...
	public Result add(@RequestBody TbTypeTemplate typeTemplate){
		if(typeTemplate!=null&&typeTemplate.getName()!=null&&!typeTemplate.equals("")) {
		try {
