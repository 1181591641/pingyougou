		...
		<div id="item"> 
			<div class="crumb-wrap">
				<ul class="sui-breadcrumb">
					<li>
						<a href="javascript:;">${itemCat1}</a>
					</li>
					<li>
						<a href="javascript:;">${itemCat2}</a>
					</li>
					<li>
						<a href="javascript:;">${itemCat3}</a>
					</li>
					...
					<div class="clearfix choose">
						<div id="specification" class="summary-wrap clearfix">
		                    ...
		                    <#list spec.attributeValue as item>
								...
								<dd><a   href="javascript:;"  ng-click="selectSpection('${spec.attributeName}','${item}')"
								class="{{isSelected('${spec.attributeName}','${item}')==true?'selected':''}}" >
						...
						<div class="summary-wrap">
							<div class="fl title">
								<div class="control-group">
									<div class="controls">
										<input autocomplete="off" type="text"  ng-model="num" value="1" minnum="" class="itxt" />
