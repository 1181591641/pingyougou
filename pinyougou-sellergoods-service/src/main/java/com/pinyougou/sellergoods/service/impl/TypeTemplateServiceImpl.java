...
public class TypeTemplateServiceImpl implements TypeTemplateService {
	...
	public TbTypeTemplate Names(TbTypeTemplate typeTemplate) {
		...
		createCriteria.andNameEqualTo(typeTemplate.getName());
		return typeTemplateMapper.selectByExample(example).get(0);
	...
	public List<Map> findSpecList(Long id) {
		// 根据id获取到TbTypeTemplate对象
		TbTypeTemplate template = typeTemplateMapper.selectByPrimaryKey(id);
		// 将数组转换为map
		List<Map> parseArray = JSON.parseArray(template.getSpecIds(), Map.class);
		// 遍历
